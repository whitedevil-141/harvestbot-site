  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#080a0a] px-5 py-12 text-neutral-100 selection:bg-[#23f8ff]/25">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 opacity-35 [background-image:linear-gradient(rgba(35,248,255,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(35,248,255,0.035)_1px,transparent_1px)] [background-size:42px_42px]" />
        <div className="absolute left-1/2 top-1/2 h-120 w-120 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#23f8ff]/8 blur-[150px]" />
        <div className="absolute -bottom-40 -right-28 h-96 w-96 rounded-full bg-amber-400/5 blur-[130px]" />
      </div>
      ...
      >
        <div className="h-px w-full bg-linear-to-r from-transparent via-[#23f8ff]/70 to-transparent" />
        <div className="px-6 py-8 sm:px-10 sm:py-10">
          <div className="flex items-center justify-between gap-4">
            <Link href="/" className="inline-flex items-center gap-2.5 text-sm font-bold tracking-tight text-white">
              <Image src="/logo.png" alt="" width={28} height={28} className="rounded-lg" priority />
              Harvest<span className="-ml-2.5 text-[#23f8ff]">Bot</span>
            </Link>
            <span className="hidden rounded-full border border-white/8 bg-white/4 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-neutral-500 sm:inline-flex">
              Checkout status
            </span>
          </div>
